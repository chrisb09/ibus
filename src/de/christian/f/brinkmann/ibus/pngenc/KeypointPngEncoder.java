...
/**
 * KeypointPngEncoder takes a Java Image object and creates a byte string which can be saved as a PNG file.
...
public class KeypointPngEncoder extends PngEncoder {
	 ...
	 * @see java.awt.Image
	 */
	public KeypointPngEncoder(Image image) {
	 ...
	 * @see java.awt.Image
	 */
	public KeypointPngEncoder(Image image, boolean encodeAlpha) {
	 ...
	 * @see java.awt.Image
	 */
	public KeypointPngEncoder(Image image, boolean encodeAlpha, int whichFilter) {
	 ...
	 * @see java.awt.Image
	 */
	public KeypointPngEncoder(Image image, boolean encodeAlpha, int whichFilter, int compLevel) {
		this.image = image;
